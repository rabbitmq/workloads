package com.pivotal.resilient.resilientspringrabbitmq.nondurable;
...
public class NonDurableResourcesConfiguration {
    ...
    @Bean
    public RabbitTemplate templateForNonDurableProducer(ConnectionFactory connectionFactory) {
